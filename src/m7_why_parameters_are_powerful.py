...
def even_better_draw_circles():
    ...
    for k in range(10):
        ...
        window.render(0.05)
    for k in range(20):
        circle2 = rg.Circle(center, 6 * k)
        circle2.outline_color = 'red'
        circle2.attach_to(window)
        window.render(0.04)
    for k in range(30):
        circle3 = rg.Circle(center, 8 * k)
        circle3.outline_color = 'orange'
        circle3.attach_to(window)
        window.render(0.03)
    for k in range(40):
        circle4 = rg.Circle(center, 10 * k)
        circle4.outline_color = 'yellow'
